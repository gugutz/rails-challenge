...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference('History.count') do
      post histories_url, params: { history: { ammount: @history.ammount, to: @history.to, type: @history.type } }
    end
  ...
  test "should update history" do
    patch history_url(@history), params: { history: { ammount: @history.ammount, to: @history.to, type: @history.type } }
